					...
					<div class="single_listing">
						...
						<div class="hotel_info">
							...
							<div class="hotel_image">
								<img src="<?= base_url('Home-css/images/listing_hotel.jpg'); ?>" alt="">
							...
							<div class="hotel_gallery">
								<div class="hotel_slider_container">
									<div class="owl-carousel owl-theme hotel_slider">
										...
										<div class="owl-item">
											<a class="colorbox cboxElement" href="<?= base_url('Home-css/images/listing_1.jpg'); ?>">
												<img src="<?= base_url('Home-css/images/listing_thumb_1.jpg'); ?>" alt="https://unsplash.com/@jbriscoe">
											</a>
										</div>

										<!-- Hotel Gallery Slider Item -->
										<div class="owl-item">
											<a class="colorbox cboxElement" href="<?= base_url('Home-css/images/listing_2.jpg'); ?>">
												<img src="<?= base_url('Home-css/images/listing_thumb_2.jpg'); ?>" alt="https://unsplash.com/@grovemade">
											</a>
										</div>

										<!-- Hotel Gallery Slider Item -->
										<div class="owl-item">
											<a class="colorbox cboxElement" href="<?= base_url('Home-css/images/listing_3.jpg'); ?>">
												<img src="<?= base_url('Home-css/images/listing_thumb_3.jpg'); ?>" alt="https://unsplash.com/@fransaraco">
											</a>
										</div>

										<!-- Hotel Gallery Slider Item -->
										<div class="owl-item">
											<a class="colorbox cboxElement" href="<?= base_url('Home-css/images/listing_4.jpg'); ?>">
												<img src="<?= base_url('Home-css/images/listing_thumb_4.jpg'); ?>" alt="https://unsplash.com/@workweek">
											</a>
										</div>

										<!-- Hotel Gallery Slider Item -->
										<div class="owl-item">
											<a class="colorbox cboxElement" href="<?= base_url('Home-css/images/listing_5.jpg'); ?>">
												<img src="<?= base_url('Home-css/images/listing_thumb_5.jpg'); ?>" alt="https://unsplash.com/@workweek">
											</a>
										</div>

										<!-- Hotel Gallery Slider Item -->
										<div class="owl-item">
											<a class="colorbox cboxElement" href="<?= base_url('Home-css/images/listing_6.jpg'); ?>">
												<img src="<?= base_url('Home-css/images/listing_thumb_6.jpg'); ?>" alt="https://unsplash.com/@avidenov">
											</a>
										</div>

										<!-- Hotel Gallery Slider Item -->
										<div class="owl-item">
											<a class="colorbox cboxElement" href="<?= base_url('Home-css/images/listing_7.jpg'); ?>">
												<img src="<?= base_url('Home-css/images/listing_thumb_7.jpg'); ?>" alt="https://unsplash.com/@pietruszka">
											</a>
										</div>

										<!-- Hotel Gallery Slider Item -->
										<div class="owl-item">
											<a class="colorbox cboxElement" href="<?= base_url('Home-css/images/listing_8.jpg'); ?>">
												<img src="<?= base_url('Home-css/images/listing_thumb_8.jpg'); ?>" alt="https://unsplash.com/@rktkn">
											</a>
										</div>

										<!-- Hotel Gallery Slider Item -->
										<div class="owl-item">
											<a class="colorbox cboxElement" href="<?= base_url('Home-css/images/listing_9.jpg'); ?>">
												<img src="<?= base_url('Home-css/images/listing_thumb_9.jpg'); ?>" alt="https://unsplash.com/@mindaugas">
											</a>
										</div>
									</div>
						...
						<div class="rooms">
							...
							<div class="room">
								...
								<div class="row">
									<div class="col-lg-2">
										<div class="room_image"><img src="<?= base_url('Home-css/images/room_1.jpg'); ?>" alt="https://unsplash.com/@grovemade"></div>
									</div>
									<div class="col-lg-7">
							...
							<div class="room">
								...
								<div class="row">
									<div class="col-lg-2">
										<div class="room_image"><img src="<?= base_url('Home-css/images/room_2.jpg'); ?>" alt="https://unsplash.com/@oowgnuj"></div>
									</div>
									<div class="col-lg-7">
										<div class="room_content">
											<div class="room_title">Double or Twin Room</div>
							...
							<div class="reviews_container">
									...
									<div class="row">
										<div class="col-lg-1">
											<div class="review_image">
												<img src="<?= base_url('Home-css/images/review_1.jpg'); ?>" alt="https://unsplash.com/@saaout">
											</div>
										</div>
										<div class="col-lg-11">
								...
								<div class="review">
									<div class="row">
										<div class="col-lg-1">
											<div class="review_image">
												<img src="<?= base_url('Home-css/images/review_2.jpg'); ?>" alt="Image by Andrew Robles">
											</div>
										</div>
										<div class="col-lg-11">
											<div class="review_content">
