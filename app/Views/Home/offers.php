							...
							<div class="row">
								...
								<div class="col-lg-3 col-1680-4">
									<div class="offers_image_container">
										...
										<div class="offers_image_background" style="background-image:url(<?= base_url('Home-css/images/offer_5.jpg'); ?>)"></div>
							...
							<div class="row">
								...
								<div class="col-lg-3 col-1680-4">
									<div class="offers_image_container">
										...
										<div class="offers_image_background" style="background-image:url(<?= base_url('Home-css/images/offer_6.jpg'); ?>)"></div>
										<div class="offer_name"><a href="single_listing.html">grand castle</a></div>
									</div>
								</div>
								<div class="col-lg-8">
