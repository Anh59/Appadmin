...
<div class="container py-4">
    <div class="d-flex align-items-center mb-3">
        ...
        <h1 class="m-0">Chi tiết lịch sử đơn hàng</h1>
    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="card-body">
                                                    ...
                                                    <p class="card-text"><strong>Thông tin phòng: </strong><?= esc($room['cancellation']) ?></p>
                                                    <p class="card-text"><strong>Tiện ích: </strong><?= esc($room['extra']) ?></p>
